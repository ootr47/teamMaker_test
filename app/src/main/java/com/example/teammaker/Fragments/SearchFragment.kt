...
class SearchFragment : Fragment() {
    ...
    private fun retrieveAllUsers()
    {
        ...
        val refUsers = Firebase.database("https://teammaker-2299d-default-rtdb.asia-southeast1.firebasedatabase.app/").reference.child("Users")
    ...
    private fun searchForUsers(str: String)
    {
        ...
        val queryUsers = Firebase.database("https://teammaker-2299d-default-rtdb.asia-southeast1.firebasedatabase.app/").reference
