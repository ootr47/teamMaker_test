...
class ChatAdapter(
    mContext: Context,
    mChatList: List<ChatData>,
    imageUrl: String
    ) : RecyclerView.Adapter<ChatAdapter.ViewHolder?>()
    {
        private val mContext: Context
        private val mChatList: List<ChatData>
        ...
        override fun onCreateViewHolder(parent: ViewGroup, position: Int): ViewHolder
        {
            ...
            {
                val view: View = LayoutInflater.from(mContext).inflate(com.example.teammaker.R.layout.message_item_right, parent, false)
                ViewHolder(view)
            }
            else
            {
                val view: View = LayoutInflater.from(mContext).inflate(com.example.teammaker.R.layout.message_item_left, parent, false)
                ViewHolder(view)
            }
        }
        ...
        {
            val chat: ChatData = mChatList[position]
